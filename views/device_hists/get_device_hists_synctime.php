...
require_once '../lib/device_hists.php';

/// This file is responsible for handling device history synchronization time requests.
...
if ($_SERVER['SECURED'] && $_SERVER['USER_LEVEL'] > 0) {
    ...
    $timestamp = new DEVICE_HISTS();
    $timestamp->setName(DEVICE_HISTS::getTableName());
